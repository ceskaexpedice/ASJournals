...
@Component({
  ...
  selector: 'app-ext-magazine-edit',
  templateUrl: './ext-magazine-edit.component.html',
  styleUrls: ['./ext-magazine-edit.component.scss']
})
export class ExtMagazineEditComponent implements OnInit {
